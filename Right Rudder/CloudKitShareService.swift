...
struct TrainingGoalsRecord {
  ...
  static func fromCKRecord(_ record: CKRecord) -> TrainingGoalsRecord? {
    ...
    return TrainingGoalsRecord(
      ...
      pplGroundSchoolCompleted: (record["pplGroundSchoolCompleted"] as? NSNumber)?.boolValue
        ?? false,
      pplWrittenTestCompleted: (record["pplWrittenTestCompleted"] as? NSNumber)?.boolValue ?? false,
      instrumentGroundSchoolCompleted: (record["instrumentGroundSchoolCompleted"] as? NSNumber)?
        .boolValue ?? false,
      instrumentWrittenTestCompleted: (record["instrumentWrittenTestCompleted"] as? NSNumber)?
        .boolValue ?? false,
      commercialGroundSchoolCompleted: (record["commercialGroundSchoolCompleted"] as? NSNumber)?
        .boolValue ?? false,
      commercialWrittenTestCompleted: (record["commercialWrittenTestCompleted"] as? NSNumber)?
        .boolValue ?? false,
      cfiGroundSchoolCompleted: (record["cfiGroundSchoolCompleted"] as? NSNumber)?.boolValue
        ?? false,
