...
struct ChecklistItemRow: View {
    ...
    init(displayItem: DisplayChecklistItem, onToggle: @escaping (Bool) -> Void, displayTitle: ((String) -> String)? = nil) {
        ...
        .gesture(
            DragGesture(minimumDistance: 30)
                ...
                .onEnded { value in
                    ...
                    print("DEBUG: isComplete: \(displayItem.isComplete), ratio: \(abs(horizontalMovement) / max(verticalMovement, 1))")
