...
class OldDatabaseEmulator: ObservableObject {
    ...
    func migrateOldDatabaseToNewSchema() async {
        ...
        do {
            ...
            let existingEmails = Set(existingStudents.compactMap { $0.email.isEmpty ? nil : $0.email.lowercased() })
            ...
            for oldStudent in oldStudents {
                ...
                newStudent.assignedCategory = oldStudent.value(forKey: "assignedCategory") as? String ?? "PPL"
