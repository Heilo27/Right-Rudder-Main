    ...
    NavigationView {
        ...
        VStack(spacing: 24) {
          ...
          VStack(alignment: .leading, spacing: 16) {
            InfoRow(
              ...
              description:
                "The student will have read-only access to their profile, checklists, and can upload required documents."
            )
            ...
            InfoRow(
              ...
              description:
                "Only this specific student can access their profile. They cannot see other students' information."
            )
            ...
            InfoRow(
              ...
              title: "Notifications",
              description:
                "Students receive push notifications when you add instructor comments to their checklists."
            )
          }
          .padding()
            ...
            VStack(spacing: 16) {
              ...
              if !participants.isEmpty {
                VStack(alignment: .leading, spacing: 8) {
                  ...
                  ForEach(participants.filter { $0.role != .owner }, id: \.userIdentity) {
                    participant in
                    HStack {
      ...
      .sheet(isPresented: $showShareSheet) {
        if let shareURL = shareURL {
          ActivityShareSheet(
            items: [shareURL],
            instructorName: instructorName.isEmpty ? "Your Instructor" : instructorName)
        }
      }
      .task {
