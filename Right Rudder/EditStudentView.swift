...
struct EditStudentView: View {
  ...
  init(student: Student) {
    ...
    self._homeAddress = State(
      initialValue: student.homeAddress.isEmpty
        ? "Enter home address (optional)" : student.homeAddress)
    self._ftnNumber = State(
      initialValue: student.ftnNumber.isEmpty ? "Enter FTN number (optional)" : student.ftnNumber)
  ...
  private func checkForChanges() {
    ...
    hasChanges =
      ...
      || categoryChanged || inactiveChanged
  }
  ...
  private func saveStudent() async {
    ...
    do {
      ...
      if saveSuccessful {
        ...
        print(
          "🔍 Saved category: '\(student.assignedCategory ?? "nil")' for student: \(student.displayName)"
        )
