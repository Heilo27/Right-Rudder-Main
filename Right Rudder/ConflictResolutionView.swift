...
struct ConflictResolutionView: View {
        ...
        VStack(spacing: 12) {
            HStack {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("The student has made changes that conflict with your data. Choose which values to keep.")
                        .font(.caption)
    ...
    private func resolveConflicts() async {
        ...
        do {
            ...
            for conflict in conflicts {
                ...
                applyResolvedValue(to: student, fieldName: conflict.fieldName, value: resolvedValue, fieldType: conflict.fieldType)
            }
    ...
    private func applyResolvedValue(to student: Student, fieldName: String, value: String, fieldType: DataConflict.ConflictFieldType) {
        switch fieldName {
        case "firstName":
            ...
            HStack(spacing: 16) {
                    ...
                    Text(conflict.instructorValue)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 8)
                                .stroke(selectedValue == conflict.instructorValue ? Color.blue : Color.clear, lineWidth: 2)
                        )
                        .onTapGesture {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text(conflict.studentValue)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 8)
                                .stroke(selectedValue == conflict.studentValue ? Color.green : Color.clear, lineWidth: 2)
                        )
                        .onTapGesture {
...
#Preview {
    ...
    let student = Student(firstName: "John", lastName: "Doe", email: "john@example.com", telephone: "555-0123", homeAddress: "123 Main St", ftnNumber: "FTN123")
