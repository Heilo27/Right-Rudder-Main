...
class EmergencyDataRecovery: ObservableObject {
    ...
    func emergencyRecovery() async {
        ...
        do {
            ...
            for (_, record) in uniqueStudents {
                ...
                if existingUUIDs.contains(uuid) {
                    ...
                    if let existing = existingStudents.first(where: { $0.id == uuid }) {
                        ...
                        if existing.firstName.isEmpty && existing.lastName.isEmpty && (!ckFirstName.isEmpty || !ckLastName.isEmpty) {
                            ...
                            existing.backgroundNotes = record["backgroundNotes"] as? String ?? existing.backgroundNotes
            ...
            recoveryProgress = "Recovery complete! Restored \(studentsRestored) students from \(studentsFound) found"
    ...
    func removeTemporaryNamedStudents() async {
        ...
        do {
            ...
            for student in allStudents {
                ...
                if student.firstName == "Student" && 
                   student.lastName.count == 8 && 
