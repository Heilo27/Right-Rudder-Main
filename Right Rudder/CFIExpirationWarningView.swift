...
struct CFIExpirationWarningView: View {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 20) {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        HStack {
                            Image(systemName: instructorCFIHasExpiration ? "calendar.badge.exclamationmark" : "clock.badge.exclamationmark")
    ...
    private func getStatusColor() -> Color {
        ...
        let daysUntilExpiration = calendar.dateComponents([.day], from: now, to: instructorCFIExpirationDate).day ?? 0
